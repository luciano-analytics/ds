...
# Portfólio de Luciano Magalhães

Bem-vindo ao repositório do meu portfólio!

Este projeto está atualmente em transição. A página `index.html` redireciona automaticamente para meu novo portfólio hospedado em:

👉 [lucianomagalhaes.netlify.app](https://lucianomagalhaes.netlify.app/)
...
© 2025 Luciano Magalhães | Todos os direitos reservados
